  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved privilege as @privilege" do
        ...
        post :create, {:privilege => { "member_class" => "invalid value" }}, valid_session
        assigns(:privilege).should be_a_new(Privilege)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested privilege" do
        ...
        Privilege.any_instance.should_receive(:update_attributes).with({ "member_class" => "MyString" })
        put :update, {:id => privilege.to_param, :privilege => { "member_class" => "MyString" }}, valid_session
      end
